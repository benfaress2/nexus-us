...
┣ Vers: ${chalk.white(packageJsonObj.version)}
┣ Descrption: ${chalk.white(packageJsonObj.description)}
┣ Os: ${chalk.white(os.type())}
┣ memior: ${chalk.white(freeRamInGB.toFixed(2) + ' / ' + ramInGB.toFixed(2))}
┣ IP: ${chalk.red(data)}
...
⎔──⎔⎔ Creator: ${chalk.bold.cyan('IDRISS BEN FARES')} ⎔⎔──⎔`)
